   ...
   <?php include 'header.php';?>
		<section class="inner-banner">
            <div class="container">
                ...
                <h2 class="inner-banner__title">Academics</h2><!-- /.inner-banner__title -->
            </div><!-- /.container -->
                ...
                <div class="row justify-content-between">
                    <div class="col-lg-5">
                        <div class="team-details__content">
                            <h2 class="team-details__title">Affiliated to CBSE</h2><!-- /.team-details__title -->
                            <p class="team-details__text">The Central Board of Secondary Education (CBSE) is one of 
							the widely recognized boards of school education in India. 
							The primary focus of CBSE is to make commendable efforts to evolve the common standards of education in India by making it more meaningful, 
							relevant and life oriented. Curriculum innovation and curriculum development has therefore been a major concern of CBSE. 
							Its respect has grown over the years as it is trying to make education relevant to the fast changing world while not 
							compromising on the quality of education.
                        </div></p><!-- /.team-details__text -->
                     </div><!-- /.row -->
					 
					 <div class="col-lg-6">
                        <div class="team-one__single">
                            <div class="team-one__image">
                                <img src="assets/images/cbse.jpg" alt="">
                            </div><!-- /.team-one__image -->
		...
		<section class="team-details">
            <div class="container">
                <div class="row justify-content-between">
                    <div class="col-lg-5">
                        <div class="team-details__content">
                            <h2 class="team-details__title">Curriculum</h2><!-- /.team-details__title -->
                            <p class="team-details__text">SHASHI INTERNATIONAL SCHOOL strives to impart holistic education to students for their overall development. The curriculum, based on core subjects, 
				focuses on providing knowledge as well as development of concepts, skills 
				and ideas. Students are encouraged to excel in various fields as Performing Arts,
				Visual Arts, Human Values, Physical Education, Leadership skills, etc for all round personality development. 
                        </div></p><!-- /.team-details__text -->
                     </div><!-- /.row -->
					 ...
					 <div class="col-lg-6">
                        <div class="team-one__single">
                            <div class="team-one__image">
                                <img src="assets/images/ac2.jpg" alt="">
                            </div><!-- /.team-one__image -->
                        </div><!-- /.team-one__single -->
                    </div><!-- /.col-lg-6 -->
	...
	<hr>
		<section class="team-details">
            <div class="container">
                <div class="row justify-content-between">
                    <div class="col-lg-5">
                        <div class="team-details__content">
                            <h2 class="team-details__title">Development</h2><!-- /.team-details__title -->
                            <p class="team-details__text">SHASHI INTERNATIONAL SCHOOL not only believes in providing academic 
				excellence to students but also aims at their holistic development by inculcating 
				essential human values in them, thus making them responsible global citizens ready 
				to surge ahead with confidence. Myriad activities conducted both inside and outside 
				the classrooms, help students to foster the right blend of moral and ethical values, 
				thus turning them into balanced personalities. Regular interactions with influential 
				dignitaries, activities like havan, recital of shlokas, harmonious celebration of festive 
				occasions, Spic Macay demonstrations, environment clubs, etc bring a multidimensional and holistic framework to the school's curriculum.
                        </div></p><!-- /.team-details__text -->
                     </div><!-- /.row -->
					 ...
					 <div class="col-lg-6">
                        <div class="team-one__single">
                            <div class="team-one__image">
                                <img src="assets/images/curri.jpg" alt="">
                            </div><!-- /.team-one__image -->
                        </div><!-- /.team-one__single -->
                    </div><!-- /.col-lg-6 -->
        ...
        <footer class="site-footer">
                        ...
                        <div class="col-xl-3 col-lg-6 col-sm-12">
                            <div class="footer-widget footer-widget__gallery">
                                ...
                                <ul class="list-unstyled footer-widget__gallery-list">
                                    <li><a href="gallery.html"><img src="kipsoassets/images/gallery1.png" alt=""></a></li>
                                    <li><a href="gallery.html"><img src="kipsoassets/images/gallery2.png" alt=""></a></li>
                                    <li><a href="gallery.html"><img src="kipsoassets/images/gallery3.png" alt=""></a></li>
                                    <li><a href="gallery.html"><img src="kipsoassets/images/gallery4.png" alt=""></a></li>
                                    <li><a href="gallery.html"><img src="kipsoassets/images/gallery5.png" alt=""></a></li>
                                    <li><a href="gallery.html"><img src="kipsoassets/images/gallery6.png" alt=""></a></li>
                                </ul><!-- /.footer-widget__gallery -->
                            </div><!-- /.footer-widget -->
                        </div><!-- /.col-lg-3 -->
                        <div class="col-xl-3 col-lg-6 col-sm-12">
                            <div class="footer-widget footer-widget__about">
                                <h2 class="footer-widget__title">School Address</h2><!-- /.footer-widget__title -->
                                <p class="footer-widget__text">Near Toll Tax ,NH-2(Baghai),Tundla,Firozabad.</p><!-- /.footer-widget__text -->
                              
                            </div><!-- /.footer-widget -->
							 <div class="footer-widget footer-widget__about">
                                <h2 class="footer-widget__title">Office Address</h2><!-- /.footer-widget__title -->
                                <p class="footer-widget__text">Block-B,Highway Regency,Near Fly Over,Tundla-Firozabad road,Tundla</p><!-- /.footer-widget__text -->
            ...
            <div class="site-footer__bottom">
                <div class="container">
                    <p class="site-footer__copy">&copy; Copyright 2020 by <a href="#">Shashiedu</a></p>
