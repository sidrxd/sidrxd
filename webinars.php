   ...
   <?php include 'header.php';?><section class="inner-banner">
            <div class="container">
                <ul class="list-unstyled thm-breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li class="active"><a href="#">Webinars and Seminars</a></li>
                </ul><!-- /.list-unstyled -->
                <h2 class="inner-banner__title">Webinars</h2><!-- /.inner-banner__title -->
            </div><!-- /.container -->
                ...
                <div class="row justify-content-between">
                    <div class="col-lg-5">
                        <div class="team-details__content">
                            <h2 class="team-details__title">The Webinars- Attended by students</h2><!-- /.team-details__title -->
                            <p class="team-details__text">18th May to 22nd May 2020 : An interactive session on “QuaranTEEN Challenge” was conducted for the students of classes IV to VIII. Through this session, the students expressed their distressing concerns as they are quarantined at home. They are missing school, teachers and their friends. But, many of them are happy to be at home as they are able to spend quality time with family members and are able to develop some new interests. They were able to differentiate between social distancing and social isolation. Social isolation, being away from school for an extended period of time, and uncertainty about what all this means for their friends and family are just a few of the concerns young children and teens shared during the interactive session.</p>
					 ...
					 <div class="col-lg-6">
                        <div class="team-details__content">
                            <div class="team-details__content">
                                 <h2 class="team-details__title"></h2><!-- /.team-details__title -->
                            <p class="team-details__text">The students actively participated in the session and shared different ways in which they are trying to deal with the stressful situation and how they are spending their time at home with their parents and grandparents, doing some household chores, doing some creative activities. During the session, they were counselled as to how they need to manage their emotions and stay positive in the times of uncertainty. They understood the importance of staying connected with each other during the times of uncertainty while maintaining social distance and learnt different coping strategies for dealing with Covid-19.
<br>
It was a step further to make the students aware about opportunity that are available and they just need to reflect and make some positive changes to their new normal by using coping mechanisms such as spending good quality time with family, play indoor games, read books, cooking together, remaining authentically connected etc. to have a healthy quarantine. The interactive session ended on a positive note.</p>
                            </div><!-- /.team-one__image -->
