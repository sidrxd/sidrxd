...
<div class="container">
   ...
   <?php include 'header.php';?><section class="inner-banner">
            <div class="container">
                ...
                <h2 class="inner-banner__title">Director's Message</h2><!-- /.inner-banner__title -->
            </div><!-- /.container -->
                ...
                <div class="row justify-content-between">
                    <div class="col-lg-5">
                        <div class="team-details__content">
                            <h2 class="team-details__title">Mr. Amit Singh</h2><!-- /.team-details__title -->
                            <p class="team-details__text">At SHASHI INTERNATIONAL SCHOOL, students are expected to have an enriching 
				and life-turning experience which will enable them to reach new heights in their professional life.
				We foster sharpening of skills and enhancement of knowledge base in our students through various extra-curricular,
