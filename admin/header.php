	...
	<head>
		...
		<title>soEpic Technologies | GALLERY - Admin</title>
							...
							<li>
								...
								<li>
									...
									<ul class="nav nav-second-level">
									    ...
									    <li>
										<a href="#"><i class="fa fa-instagram fa-fw"></i>Docs<span class="fa arrow"></span></a>
										<ul class="nav nav-second-level">
											<li>
												<a href="adddocs.php">Add Documents</a>                                </li>
												<li>
													<a href="viewalldocs.php">View Docs</a>  
												</li>
										...
										<li>
											<a href="#"><i class="fa fa-instagram fa-fw"> UI Elements</i><span class="fa arrow"></span></a>
											<ul class="nav nav-second-level">
												<li>
													<a href="uielements.php">UI Elements</a>                                </li>
												</ul>
												<!-- /.nav-second-level -->
											</li>
