...
<tbody>
                                        <tr>
                                           ...
                                           <td><a href='albumdelete.php?key1=<?php echo $row["albumid"]; ?>'>Delete</a> |

                                            <a href = 'editalbum.php?key0=<?php echo $row["albumid"]; ?> &key1=<?php echo $row["name"]; ?> &key2=<?php echo $row["adesc"]; ?>&key3=<?php echo $row["image"]; ?> '>Edit</a>
