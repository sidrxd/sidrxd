                ...
                <ul class="nav nav-second-level">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                           ...
                           <li >
                        <a href="#"><i class="fa fa-file-photo-o fa-fw"></i>Documents<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><?php if(isset($_SESSION['uname'])){?>
                                <a class="active" href="adddocs.php">Add Documents</a><?php }?></li>
                                <li>
                                  <?php if(isset($_SESSION['uname'])){?>  <a href="viewalldocs.php">View Documents</a><?php }?>                                </li>
                              </ul>
                              <!-- /.nav-second-level -->
                          </li>
