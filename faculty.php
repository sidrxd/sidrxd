...
<div class="container">
   ...
   <?php include 'header.php';?><section class="inner-banner">
            <div class="container">
                <ul class="list-unstyled thm-breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li class="active"><a href="#">Faculty</a></li>
                </ul><!-- /.list-unstyled -->
                <h2 class="inner-banner__title">Faculty &amp; Staff</h2><!-- /.inner-banner__title -->
            </div><!-- /.container -->
                ...
                <div class="row justify-content-between">
                    <div class="col-lg-5">
                        <div class="team-details__content">
                            <h2 class="team-details__title">About Faculty of SIS</h2><!-- /.team-details__title -->
                            <p class="team-details__text">
							<p class="team-details__text" align = left >Teachers at SIS bring diverse teaching experiences from some of the finest learning institutions  What brings them together at SIS is their deep commitment to children and their pursuit of excellence as educators.
<br>
SIS Teachers are :

<li>Experts in their Field
<br><li>Passionate Educators
<br><li>Responsive Instructors
<br><li>Master Collaborators
<br><li>Avid Researchers
<br>
<li>SIS faculty are invested professionals who care deeply about children and the field of education. SIS teachers understand that each child learns differently and that teaching methods, curricula and approach need to be responsive to these differences. Teachers are committed to dedicate ample time to studying the process of the way each child learns in order to design and individualized plan to help students meet and exceed their goals. 
<br>
<li>Teachers at SIS will work to create learning communities in the classroom and the broader community. They are experts at cultivating an environment in which students take risks, work hard and celebrate the learning process. With students and their families, SIS teachers will listen carefully, ask thoughtful questions and effectively communicate. 
<br>
					...
					<div class="col-lg-6">
						...
						<p class="team-details__text" align = "justify">
<li>Teachers at SIS are commited to model a passion for learning, excitement for subject matter and creativity in thinking. 
Teachers work in collaborative teams to share expertise, pool resources and plant innovative programs. Because of SIS commitment to best practices and professional learning, working within this collaborative model will allow teachers greater access to new research and teaching methods, which they can then incorporate into curricula and their own teaching styles. SIS teachers will always be avid participants in our learning community, consistently honing and refining their art as educators. The result of this engagement is a palpable energy that will infuse the school and promote a school-wide passion for learning. In the SIS community, teachers act as mentors when sharning areas of expertise and in turn continually seek out the knowledge of others to promote their own learning. Reflecting on and re-examining methods, programs and philosophy, will be a hallmark of SIS dynamic teaching community. 
</ul>
</ul></p>
                    </div><!-- /.col-lg-6 -->
