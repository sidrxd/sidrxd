...
<div class="container">
   ...
   <?php include 'header.php';?><section class="inner-banner">
            <div class="container">
                ...
                <h2 class="inner-banner__title">Principal's Desk</h2><!-- /.inner-banner__title -->
            </div><!-- /.container -->
                ...
                <div class="row justify-content-between">
                    <div class="col-lg-5">
                        <div class="team-details__content">
                            <h2 class="team-details__title">Principal</h2><!-- /.team-details__title -->
                            <p class="team-details__text">“If you are planning for a year, sow rice; 
If you are planning for a decade, plant trees;
If you planning for a lifetime, educate people”

Education is a lifelong learning process. Learning happens all the time; not only in a pre- designated place called school. It happens at home, between home and school too.
Shaping young, impressionable minds is one of life’s biggest challenges. I wish my students to grow as individuals with strong open discerning minds with an international 
perspective, preparing them to make a mark in the global village- the world has come to be today.</p>
